...
(def clauses
     ...
     {:key "limit"    :label "Limit"            :bootstrap_span 1      :tooltip_title "Limit Clause"     :tooltip_body "The maximum number of results to return. Defaults to 100. For HTML output format, the hard limit is 1000."}
