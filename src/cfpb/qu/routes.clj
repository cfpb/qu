...
;;  (GET "/data/:dataset/concepts.:extension" [dataset] resources/concepts)
;;  (GET "/data/:dataset/concepts" [dataset] resources/concepts)  
  ...
  (GET "/data/:dataset/slice/:slice.:extension" [dataset slice] resources/slice)
  (GET "/data/:dataset/slice/:slice" [dataset slice] resources/slice)  
